/*  
 * timer_diff.c 
 * The following program demonstrates the di erence among three di erent timers. Write a 
 * simple “while(1) loop” program first and execute several instances of this program as the 
 * number of cores in your machine. For example, if you have a dual core machine, then run two 
 * “while(1) loop” programs simultaneously. After occupy all computing resources, execute 
